...
os.system(f'''python3 pretrain/xla_spawn.py --num_cores 8 pretrain/pretrain.py --model_name_or_path {os.environ['MODEL_PATH']} \
    ...
    --save_strategy no --evaluation_strategy steps --eval_steps 500 --logging_steps 500 --max_train_samples 1000 \
